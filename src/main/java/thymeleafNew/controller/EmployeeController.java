package thymeleafNew.controller;
...
import thymeleafNew.repository.IEmployeeRepository;
...
public class EmployeeController {
	...
	//ModelAndView=Web MVC çerçevesinde hem Model hem de Görünüm için tutucu. Bunların tamamen 
	...
	//bir obje oluştur ModelAndView den, içinde list-employee olsun, obje ekle, backendden verileri getirsin
		// 1.yontem
		...
		// addObject(modelName, modelObject); şeklinde de yazılır
	...
	//burası react taki ekleme sayfasını aç diye çalışıyor
		...
		public ModelAndView addEmployeeForm() {//4)list-employees (üstteki) class ındaki, add employee butonuna basınca burası tetiklendi
